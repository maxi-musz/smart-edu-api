...
export class SessionAndTermDocs {
  ...
  static get createOperation() {
    return ApiOperation({
      ...
      description:
        'Create a new academic session for a school. This endpoint automatically creates the specified number of terms (defaults to 3) for the academic year. Terms are evenly distributed across the academic year period. Schools can choose 1, 2, or 3 terms based on their preference.',
    });
  }
              ...
              terms: {
                ...
                items: {
                  ...
                  properties: {
                    id: {
                      type: 'string',
                      example: 'cmiu4ti1y0004mkcywi8w62s2',
                    },
                    school_id: {
                      type: 'string',
                      example: 'cmiu4ti150000mkcyxggp8dik',
                    },
                    academic_year: { type: 'string', example: '2024/2025' },
    ...
    return ApiResponse({
      ...
      schema: {
        ...
        properties: {
          ...
          message: {
            type: 'string',
            example: 'Failed to create academic session: [error message]',
          },
          data: { type: 'null', example: null },
  ...
  static get updateSessionOperation() {
    return ApiOperation({
      ...
      description:
        'Update an academic session (all terms). Can update start_date, end_date, and set as active session. If is_current is set to true, the first term is automatically set as the active term.',
    });
  }
    ...
    return ApiResponse({
      ...
      schema: {
        ...
        properties: {
          ...
          message: {
            type: 'string',
            example: 'Failed to update academic session: [error message]',
          },
          data: { type: 'null', example: null },
          statusCode: { type: 'number', example: 500 },
        },
  ...
  static get updateTermOperation() {
    return ApiOperation({
      ...
      description:
        'Update a specific term. Can update start_date, end_date, and set as active term. If is_current is set to true, all other terms in the session are deactivated.',
    });
  }
    ...
    return ApiResponse({
      ...
      schema: {
        ...
        properties: {
          ...
          message: {
            type: 'string',
            example: 'Failed to update term: [error message]',
          },
          data: { type: 'null', example: null },
          statusCode: { type: 'number', example: 500 },
        },
