...
export class UserController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve comprehensive student profile including academic, personal, guardian, and performance information',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve comprehensive student profile in mobile app format with general info, academic info, settings, and support info',
  })
  @ApiResponse({
    status: 200,
