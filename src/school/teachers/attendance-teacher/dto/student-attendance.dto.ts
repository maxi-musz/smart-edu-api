...
export class StudentAttendanceExtendedDto extends StudentAttendanceDto {
  @ApiProperty({
    ...
    description: 'All available academic sessions',
  })
  ...
  @ApiProperty({
    example: [
      {
        id: 'cmft0keqn00avsbkyybjn0ra0',
        term: 'first',
        academic_year: '2024-2025',
      },
      {
        id: 'cmft0keqn00avsbkyybjn0ra1',
        term: 'second',
        academic_year: '2024-2025',
      },
      {
        id: 'cmft0keqn00avsbkyybjn0ra2',
        term: 'third',
        academic_year: '2024-2025',
      },
    ],
...
export class StudentAttendanceResponseDto {
  ...
  @ApiProperty({
    example: 'Student attendance retrieved successfully',
...
export class StudentAttendanceExtendedResponseDto {
  ...
  @ApiProperty({
    type: StudentAttendanceExtendedDto,
    description: 'Student attendance data with sessions and terms',
  })
