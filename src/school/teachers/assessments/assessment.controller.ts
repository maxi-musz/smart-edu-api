...
import { AssessmentDocs } from './docs/assessment.docs';
...
export class AssessmentController {
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Teacher does not have access to topic',
  })
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad request - subject_id is required',
  })
  ...
  async getAllAssessments(
    ...
    return this.assessmentService.getAllAssessments(user.sub, {
      status,
      subjectId,
      topicId,
      assessmentType,
  ...
  @ApiResponse({
    status: 200,
    description: 'Topic quizzes retrieved successfully',
  })
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Teacher does not have access to topic',
  ...
  @Get(':id/attempts')
  @ApiOperation({
    summary: 'Get all students and their attempts for an assessment',
  })
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Teacher does not have access to this assessment',
  })
  ...
  @ApiOperation({
    summary: "Get a specific student's submission for an assessment",
  })
  @ApiParam({ name: 'id', description: 'ID of the assessment' })
  @ApiParam({
    name: 'studentId',
    description: 'ID of the student record (Student.id)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 404,
    description: 'Not found - Assessment or student not found or access denied',
  })
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Teacher does not have access to this assessment',
  ...
  async uploadQuestionImage(
    ...
    return this.assessmentService.uploadQuestionImage(
      assessmentId,
      imageFile,
      user.sub,
    );
  ...
  @ApiBody({
    ...
    description:
      'Question data. If you have an image, upload it first using /upload-image endpoint and use the returned image_url here.',
  })
  ...
  @UseInterceptors(FileInterceptor('image'))
  @AssessmentDocs.createQuestionWithImage.operation
  @AssessmentDocs.createQuestionWithImage.param
  @AssessmentDocs.createQuestionWithImage.consumes
  @AssessmentDocs.createQuestionWithImage.body
  @AssessmentDocs.createQuestionWithImage.response201
  @AssessmentDocs.createQuestionWithImage.response400
  @AssessmentDocs.createQuestionWithImage.response404
  @AssessmentDocs.createQuestionWithImage.response403
  ...
  @ApiResponse({
    status: 200,
    description: 'Assessment results released successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Not found - Assessment not found or access denied',
