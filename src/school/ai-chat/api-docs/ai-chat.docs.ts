...
export const UploadDocumentDocs = {
  operation: () =>
    ApiOperation({
      ...
      description:
        'Upload a PDF, DOC, DOCX, PPT, or PPTX document to enable AI chat functionality. Subject and topic are optional - you can upload any material for AI chat.',
    }),
            ...
            data: {
              ...
              properties: {
                ...
                url: {
                  type: 'string',
                  example:
                    'https://bucket.s3.region.amazonaws.com/ai-chat/schools/...',
                },
                fileType: { type: 'string', example: 'pdf' },
                size: { type: 'string', example: '2.3 MB' },
                originalName: {
                  type: 'string',
                  example: 'algebra_chapter5.pdf',
                },
                subject_id: {
                  type: 'string',
                  example: 'clx1234567890abcdef',
                  description: 'Optional - empty if not provided',
                },
                topic_id: {
                  type: 'string',
                  example: 'clx1234567890abcdef',
...
export const StartUploadDocs = {
  operation: () =>
    ApiOperation({
      ...
      description:
        'Start a document upload with real-time progress tracking via SSE',
    }),
            ...
            data: {
              ...
              properties: {
                ...
                progressEndpoint: {
                  type: 'string',
                  example:
                    '/api/v1/ai-chat/upload-progress/upload_session_1234567890',
                },
              },
            },
        ...
        content: {
          'text/event-stream': {
            schema: {
              type: 'string',
              example:
                'data: {"sessionId":"upload_session_123","progress":45,"stage":"uploading","message":"Uploading to cloud storage...","bytesUploaded":1048576,"totalBytes":2097152}\n\n',
            },
          },
        },
      }),
...
export const ProcessDocumentDocs = {
  operation: () =>
    ApiOperation({
      ...
      description:
        'Start processing a uploaded document to extract text, create chunks, and generate embeddings',
    }),
            ...
            data: {
              ...
              items: {
                ...
                properties: {
                  id: {
                    type: 'string',
                    example: 'cmfh35jfh0002sbix6l9n752e_chunk_0',
                  },
                  content: {
                    type: 'string',
                    example: 'This is the first chunk of the document...',
                  },
            ...
            data: {
              ...
              items: {
                ...
                properties: {
                  ...
                  content: {
                    type: 'string',
                    example: 'This chunk contains information about...',
                  },
          ...
          properties: {
            ...
            data: {
              ...
              properties: {
                ...
                content: {
                  type: 'string',
                  example: 'Based on the document, the main topic is...',
                },
...
export const InitiateAiChatDocs = {
  operation: () =>
    ApiOperation({
      ...
      description:
        'Initialize AI chat based on user role and return available materials for teachers',
    }),
...
export const DeleteConversationDocs = {
  operation: () =>
    ApiOperation({
      ...
      description:
        'Deletes a conversation and optionally deletes the associated document and its vectors',
    }),
