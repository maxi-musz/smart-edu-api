...
import {
  AddNewTeacherDto,
  UpdateTeacherDto,
} from 'src/school/director/teachers/teacher.dto';
...
export const GetTeachersDashboardDocs = {
  operation: ApiOperation({
    ...
    description:
      'Retrieve comprehensive teachers dashboard with statistics, teacher list, and next class schedules',
  }),
  ...
  response200: ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Teachers dashboard data fetched successfully',
        },
        data: {
          type: 'object',
          properties: {
...
export const GetClassesAndSubjectsDocs = {
  operation: ApiOperation({
    ...
    description:
      'Fetch all available classes and subjects for creating a new teacher with proper assignments',
  }),
  bearerAuth: ApiBearerAuth('JWT-auth'),
  response200: ApiResponse({
    status: 200,
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Classes and subjects fetched successfully',
        },
        data: {
          type: 'object',
          properties: {
...
export const AddNewTeacherDocs = {
  operation: ApiOperation({
    ...
    description:
      'Create a new teacher with strong password generation, welcome email sending, and subject/class assignments',
  }),
  bearerAuth: ApiBearerAuth('JWT-auth'),
  body: ApiBody({
        ...
        data: {
          ...
          properties: {
            ...
            generatedPassword: {
              ...
              example: 'jd1234edu@5',
              description:
                'Auto-generated password (only returned if no password was provided)',
              nullable: true,
            },
          },
        },
...
export const UpdateTeacherDocs = {
  operation: ApiOperation({
    ...
    description:
      'Update teacher details with school validation and selective field updates. Only provided fields will be updated. Teacher must belong to the same school as the authenticated user.',
  }),
  bearerAuth: ApiBearerAuth('JWT-auth'),
  param: ApiParam({
    name: 'id',
  ...
  body: ApiBody({
    description:
      'Updated teacher data (all fields are optional for partial updates)',
...
export const GetAllTeachersDocs = {
  operation: ApiOperation({
    ...
    description:
      'Retrieve paginated list of all teachers with optional filtering',
  }),
  bearerAuth: ApiBearerAuth('JWT-auth'),
  query: ApiQuery({
    name: 'page',
  ...
  response200: ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Teachers list retrieved successfully',
        },
        data: {
          type: 'object',
          properties: {
