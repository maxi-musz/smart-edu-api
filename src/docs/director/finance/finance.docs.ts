...
export const GetFinanceDashboardDocs = {
  operation: ApiOperation({
    ...
    description:
      'Fetch finance dashboard data including revenue, expenses, and financial statistics for the authenticated director',
  }),
  ...
  response200: ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example: 'Finance dashboard data fetched successfully',
        },
        data: {
          type: 'object',
          properties: {
