...
export const BulkOnboardDocs = {
  operation: ApiOperation({
    ...
    description:
      'Upload an Excel file to bulk onboard teachers, students, and directors. The Excel file must have the following columns: First Name, Last Name, Email, Phone, Class, Role.',
  }),
...
export const DownloadTemplateDocs = {
  operation: ApiOperation({
    ...
    description:
      'Download a pre-formatted Excel template with the correct column headers and example data for bulk onboarding',
  }),
  bearerAuth: ApiBearerAuth('JWT-auth'),
